...
- 㓌手指：以專題形式，用最少的字數搭建知識體系的框架。旨在把學術帶向人閒。<n1>主要是因爲有些東西網絡上不好找，書上現成的多一些。「㓌」是「金」本字的隸定，不讀 quán。「金手指」指小時候遊戲機的作弊器</n1>
...
- 讀專著：一些稍微成文的讀書筆記；不成文的和讀原典的筆記放在 [維基](https://kqh.wiki)。這些標題原創性依次增加：摘錄——述要——指要——讀某——某讀後。「讀後」可以當成半篇論文了，作爲副標題出現
- 學務：上學期間雜七雜八的東西
- 觀後：博物館展覽；電影；音樂
- 報摘：爲當下的厤㕜提供一些索引。對應的，[維基](https://kqh.wiki) 上有「複印報刊資料」系列，主要是全文保存。
- 墨池記：有關書法的想法、記錄等
- 彫梓記：有關字體、排版、編輯的
