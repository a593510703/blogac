...
9. 【顏色】紅色爲 `#c41011`，粉色爲 `ffc7c7`，黑色爲 `#2b2b2b`，背㬌黃色爲 ~~#fffbe0~~ `#ff fae3`。超鏈接用紅色，懸浮時用粉色背㬌。
